...
function s.rmtg(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then return s[tp]>0 and Duel.IsExistingMatchingCard(s.rmfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil) end
    ...
    local g=Duel.SelectTarget(tp,s.rmfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,s[tp],nil)
