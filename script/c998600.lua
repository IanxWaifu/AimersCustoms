...
function s.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x12EA))
	e1:SetTargetRange(LOCATION_MZONE,0)
...
function s.poscon(e,tp,eg,ep,ev,re,r,rp)
	...
	e:SetLabelObject(bc)
	return ct>=3 and ac:IsCanChangePosition() and ac:IsControler(tp) and ac:IsSetCard(0x12EA) and ac:IsType(TYPE_RITUAL+TYPE_SYNCHRO) and bc:IsControler(1-tp)
end
