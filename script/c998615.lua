...
function s.initial_effect(c)
	...
	e6:SetCategory(CATEGORY_TODECK+CATEGORY_REMOVE)
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x12EA) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE) and c:IsFaceup()
end
