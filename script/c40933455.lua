...
function c40933455.initial_effect(c)
	--link summon
	Link.AddProcedure(c,c40933455.sfilter1,2,2,c40933455.lcheck)
	c:EnableReviveLimit()
	--special summon
...
function c40933455.sfilter1(c)
	return c:IsSetCard(0x1004) and not c:IsCode(40933455)
end
function c40933455.sfilter2(c)
	return (c:IsType(TYPE_RITUAL) or c:GetSummonLocation()==LOCATION_EXTRA) and not c:IsCode(40933455)
end
