...
function c405106.initial_effect(c)
	--synchro summon
	Synchro.AddProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0x7b),1,1,Synchro.NonTuner(c405106.mfilter2),1,99)
	c:EnableReviveLimit()
	--add
