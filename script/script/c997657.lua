...
function s.mattg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return s.matfilter(chkc) and chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) end
	if chk==0 then return Duel.IsExistingTarget(s.matfilter,tp,LOCATION_MZONE,0,1,e:GetHandler())
