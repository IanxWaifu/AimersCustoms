function c1553085.initial_effect(c)
	--xyz summon
	Xyz.AddProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0xFA0),5,2)
	c:EnableReviveLimit()
	--Add
...
function c1553085.filter(c)
	return c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsSetCard(0xFB0) and c:IsAbleToHand()
end
