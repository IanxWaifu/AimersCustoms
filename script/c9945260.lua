function c9945260.initial_effect(c)
	--synchro summon
	Synchro.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,0x204f),1,1,Synchro.NonTuner(c9945260.syncfilter),1,99)
	c:EnableReviveLimit()	
	--draw
...
c9945260.ritual_material_required=1
