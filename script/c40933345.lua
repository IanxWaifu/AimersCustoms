...
function c40933345.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,79580323,29357956)
	Fusion.AddContactProc(c,c40933345.contactfil,c40933345.contactop,c40933345.splimit)
	--Cannot Activate
...
c40933345.listed_series={0x19}
c40933345.listed_names={79580323}
c40933345.listed_names={29357956}
c40933345.material_setcode={0x19}
function c40933345.contactfil(tp)
...
function c40933345.contactop(g,tp)
	Duel.ConfirmCards(1-tp,g)
	Duel.SendtoDeck(g,nil,SEQ_DECKSHUFFLE,REASON_COST+REASON_MATERIAL)
end
function c40933345.splimit(e,se,sp,st)
