...
function s.initial_effect(c)
	...
	e1:SetCondition(function(e) return e:GetHandler():GetLinkedGroup():IsExists(s.linkfilter1,1,nil) and e:GetHandler():GetLinkedGroup():IsExists(s.linkfilter2,1,nil) end)
	e1:SetTarget(s.untg)
