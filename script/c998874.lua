...
function s.tfilter(c,tp)
	return c:IsOnField() and c:IsControler(tp) and c:IsSetCard(0x19f) and c:IsFaceup()
end
...
function s.discon2(e,tp,eg,ep,ev,re,r,rp)
	...
	e:SetLabelObject(d)
	return a:IsControler(tp) and a:IsFaceup() and a:IsSetCard(0x19f) and a:IsType(TYPE_FUSION)  and a:GetControler()~=d:GetControler()
end
