...
function s.filter(c)
	return c:IsSetCard(0x12D9) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
...
function s.eqcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_ONFIELD) and not e:GetHandler():IsReason(REASON_LOST_TARGET)
end
