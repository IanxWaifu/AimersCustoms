...
function s.actop(e,tp,eg,ep,ev,re,r,rp)
	...
	if not (tc2:IsRelateToEffect(e) and tc2:IsFaceup()) or Duel.GetLocationCount(tp,LOCATION_SZONE)<=0 then return end
	local sg=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.actfilter2),tp,LOCATION_GRAVE+LOCATION_HAND,0,1,1,nil,tp,tc2)
